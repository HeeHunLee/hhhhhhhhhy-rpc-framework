package github.hhhhhhhhhy.remoting.transport.netty.codec;

import github.hhhhhhhhhy.compress.Compress;
import github.hhhhhhhhhy.enums.CompressTypeEnum;
import github.hhhhhhhhhy.enums.SerializationTypeEnum;
import github.hhhhhhhhhy.extension.ExtensionLoader;
import github.hhhhhhhhhy.remoting.constants.RpcConstants;
import github.hhhhhhhhhy.remoting.dto.RpcMessage;
import github.hhhhhhhhhy.remoting.dto.RpcRequest;
import github.hhhhhhhhhy.remoting.dto.RpcResponse;
import github.hhhhhhhhhy.serialize.Serializer;
...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    //自定义的传输协议：魔法数+版本号+消息的长度+消息的类型+压缩类型+序列化类型+消息的长度
